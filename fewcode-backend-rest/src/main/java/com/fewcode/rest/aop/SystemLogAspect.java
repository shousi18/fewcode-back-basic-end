...
import com.fewcode.common.model.BaseLog;
...
import static com.fewcode.common.config.BaseConstants.MAX_TEXT_LENGTH;
...
public class SystemLogAspect {
    ...
    @Pointcut(value = "@annotation(com.fewcode.common.model.BaseLog)")
    ...
    public Object doAround(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        BaseLog mapleLog = method.getAnnotation(BaseLog.class);
        ...
        try {
            ...
            // 取JWT的登录信息，无需登录可以忽略
            if (request.getHeader(BaseConstants.TOKEN_NAME) != null) {
